...
public class Employee {
    ...
    public Employee (String n, String num, String date)
    {
        ...
        } catch (InvalidEmployeeNumber invalidEmployeeNumber) {
            invalidEmployeeNumber.printStackTrace();
        }
        hireDate = date;
    }
    /**The no-arg constructor initializes an object with
     *  null settings for name., employee number and hire
     *  date.
     */
    public Employee()
    {
     ...
     *          number.
     *@return true if e references a vlid ID number
     *          false otherwise.
     */
